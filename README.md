...
`lessons/` เก็บตัวอย่าง starter และเฉลยที่ตั้งใจแจก ส่วนการแก้โค้ดของผู้เรียนใช้ `practics/` ซึ่ง `.gitignore` ไม่เพิ่มเข้า Git ตามปกติ เช่น `practics/phase-01/ep01-hello-go` มี module แยก จึงทดลองแก้โค้ดได้โดยไม่กระทบตัวอย่างต้นฉบับ อ่าน [วิธีฝึกและสร้างพื้นที่หลัง clone](docs/PRACTICE.md)
